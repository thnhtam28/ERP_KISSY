...
namespace Erp.BackOffice.Helpers
{
    ...
    public enum WidthType
    {
        ...
        [Display(Name = "NoteTxtArea col-xs-12")]
        span14 = 14,
        [Display(Name = "txtName")]
        span15 = 15,
    }
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString CustomTextboxFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, string placeHolder = null, string inputMask = null, WidthType widthType = WidthType.span6, bool IsCheckValidation = true, Dictionary<string, object> htmlAttributeInput = null, string stringFormat = null, string labelClass = "control-label col-lg-5 col-md-4 col-sm-4 txtName-POS", string controlClass = "col-lg-7 col-md-8 col-sm-8 txtName-POS")
        {
            ...
            if (result != null)
            {
                switch (result.GetType().FullName)
                {
                    ...
                    case "System.Decimal":
                        ...
                        {
                            sDisplayText = Helpers.Common.PhanCachHangNgan(result.ToString());
                        }
                        else
                        {
