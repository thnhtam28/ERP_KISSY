...
namespace Erp.BackOffice.Account.Models
{
    public class CustomerViewModel
    {
        ...
        [StringLength(20, ErrorMessageResourceType = typeof(Error), ErrorMessageResourceName = "StringError", ErrorMessage = null)]
        [Display(Name = "Code", ResourceType = typeof(Wording))]
        public string Code { get; set; }

        //[StringLength(100, ErrorMessageResourceType = typeof(Error), ErrorMessageResourceName = "StringError", ErrorMessage = null)]
        [Required(ErrorMessageResourceName = "Required2",ErrorMessageResourceType = typeof(Wording))]
        ...
        [Required(ErrorMessageResourceName = "Required3", ErrorMessageResourceType = typeof(Wording))]
        [RegularExpression("(09|03|07|08|05)+([0-9]{8})", ErrorMessageResourceName ="MobileError", ErrorMessageResourceType = typeof(Wording))]
