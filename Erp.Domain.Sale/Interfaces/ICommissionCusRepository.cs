...
namespace Erp.Domain.Sale.Interfaces
{
    public interface ICommissionCusRepository
    {
        ...
        IQueryable<vwCommissionCus> GetAllvwCommissionCus();
        IQueryable<vwCommissionCus_ch> GetAllvwCommissionCus_ch();
        List<vwCommissionCus_ch> GetListAllvwCommissionCus_ch();
        /// <summary>
