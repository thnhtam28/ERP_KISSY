...
namespace Erp.Domain.Sale.Interfaces
{
    public interface ICommisionCustomerRepository
    {
        ...
        IQueryable<vwCommisionCustomer> GetAllCommisionCustomer();
        List<vwCommisionCustomer> GetListAllCommisionCustomer();
        IQueryable<CommisionCustomer> GetAllCommisionCustomerbyidcus(int idcus);
        /// <summary>
        ...
        void DeleteAllCommissionCustomerByIdCus(int IdCus);
    }
}
