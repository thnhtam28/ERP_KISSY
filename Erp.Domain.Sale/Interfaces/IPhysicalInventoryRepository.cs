...
namespace Erp.Domain.Sale.Interfaces
{
    public interface IPhysicalInventoryRepository
    {
        ...
        IQueryable<PhysicalInventoryDetailchildren> GetAllPhysicalInventoryDetailchildren(int PhysicalInventoryDetailchildrenId);
        //IQueryable<vwPhysicalInventoryDetail> GetAllvwPhysicalInventoryDetail(int PhysicalInventoryId);

        PhysicalInventoryDetailchildren GetPhysicalInventoryDetailchildrenById(int Id);

        void InsertPhysicalInventoryDetailchildren(PhysicalInventoryDetailchildren PhysicalInventoryDetailchildren);

        void DeletePhysicalInventoryDetailchildren(int Id);

        void DeletePhysicalInventoryDetailchildrenRs(int Id);

        void UpdatePhysicalInventoryDetailchildren(PhysicalInventoryDetailchildren PhysicalInventoryDetailchildren);
    }
}
