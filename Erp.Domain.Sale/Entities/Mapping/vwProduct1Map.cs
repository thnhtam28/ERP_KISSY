...
{
    public class vwProduct1Map : EntityTypeConfiguration<vwProduct1>
    {
        public vwProduct1Map()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            //this.Property(t => t.imagepos).HasColumnName("imagepos");
            ...
            this.Property(t => t.NhomCha).HasColumnName("NhomCha");
        }
    }
}
