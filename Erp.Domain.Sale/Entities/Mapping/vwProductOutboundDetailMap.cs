...
namespace Erp.Domain.Sale.Entities.Mapping
{
    public class vwProductOutboundDetailMap : EntityTypeConfiguration<vwProductOutboundDetail>
    {
        public vwProductOutboundDetailMap()
        {
            ...
            //this.Property(t => t.Detail_InboundQuantity).HasColumnName("Detail_InboundQuantity");
            //this.Property(t => t.Detail_OutboundQuantity).HasColumnName("Detail_OutboundQuantity");
            //this.Property(t => t.Detail_InventoryQuantity).HasColumnName("Detail_InventoryQuantity");
        }
    }
}
