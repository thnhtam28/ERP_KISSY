...
namespace Erp.Domain.Sale.Entities.Mapping
{
    public class vwRequestInboundDetailMap : EntityTypeConfiguration<vwRequestInboundDetail>
    {
        public vwRequestInboundDetailMap()
        {
            ...
            this.Property(t => t.ProductGroupName).HasColumnName("RQCode");
            this.Property(t => t.ProductGroupName).HasColumnName("QRBranchId");
            this.Property(t => t.ProductGroupName).HasColumnName("QRBranchName");
            this.Property(t => t.ProductGroupName).HasColumnName("RQStatus");
