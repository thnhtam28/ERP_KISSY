...
namespace Erp.Domain.Sale.Entities.Mapping
{
    public class vwProductInboundMap : EntityTypeConfiguration<vwProductInbound>
    {
        public vwProductInboundMap()
        {
            ...
            this.Property(t => t.BranchId_khonhan).HasColumnName("BranchId_khonhan");
            ...
            this.Property(t => t.CodeOrderRed).HasColumnName("CodeOrderRed");
            this.Property(t => t.DateOrder).HasColumnName("DateOrder");
        }
    }
}
